package com.genzvirus.theartifact.blocks;
...
public class StairsBlock extends Block implements IWaterLoggable {
	...
	public StairsBlock(AbstractBlock.Properties properties) {
		...
		this.registerDefaultState(
				this.stateDefinition.any().setValue(FACING, Direction.NORTH).setValue(HALF, Half.BOTTOM).setValue(SHAPE, StairsShape.STRAIGHT).setValue(WATERLOGGED, Boolean.valueOf(false)));
	...
	public BlockState getStateForPlacement(BlockItemUseContext p_196258_1_) {
		...
		BlockState blockstate = this.defaultBlockState().setValue(FACING, p_196258_1_.getHorizontalDirection())
				.setValue(HALF, direction != Direction.DOWN && (direction == Direction.UP || !(p_196258_1_.getClickLocation().y - (double) blockpos.getY() > 0.5D)) ? Half.BOTTOM : Half.TOP)
	...
	public BlockState updateShape(BlockState p_196271_1_, Direction p_196271_2_, BlockState p_196271_3_, IWorld p_196271_4_, BlockPos p_196271_5_, BlockPos p_196271_6_) {
		...
		return p_196271_2_.getAxis().isHorizontal() ? p_196271_1_.setValue(SHAPE, getStairsShape(p_196271_1_, p_196271_4_, p_196271_5_))
